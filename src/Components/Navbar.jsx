          ...
          >
            ...
            >
              ...
              <a
                ...
                href="https://drive.google.com/file/d/1mOFsplGUUaFNI3fw4h2NhcTD4WDFYGVx/view?usp=sharing"
                target="_blank"
                rel="noreferrer"
              >
        ...
        {isOpen ? (
          ...
          >
            <Stack as={"nav"} spacing={4} color="#3197" fontWeight="600">
              ...
              <Text
                cursor="pointer"
                onclick="window.open('https://drive.google.com/file/d/1mOFsplGUUaFNI3fw4h2NhcTD4WDFYGVx/view?usp=sharing')"
              >
                Resume
              </Text>
            </Stack>
