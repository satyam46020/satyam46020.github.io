          ...
          >
            ...
            <Box p="6">
              ...
              <Box
                ...
                mb={{ lg: 6 }}
              >
                Myntra is a stylish and user-centric e-commerce platform that brings the latest fashion trends to your fingertips. This Myntra clone website is designed to offer a seamless and enjoyable online shopping experience, allowing users to explore, discover, and shop for a wide range of fashion.
              </Box>
              <Box
          ...
          >
            ...
            <Box p="6">
              ...
              <Box
                ...
                mb={{ lg: 6 }}
              >
                Pharmacy is an innovative Pharmacy Management System designed to streamline and modernize pharmacy operations. This comprehensive software solution empowers pharmacies to efficiently manage inventory, enhance customer service, and maintain accurate records.
              </Box>
              <Box
                display={{ base: "column", sm: "column", lg: "flex" }}
                alignItems="baseline"
          ...
          >
            ...
            <Box p="6">
              ...
              <Box
                ...
                mb={{ lg: 6 }}
              >
                This is my portfolio project! This project contains all the valuable insights of me, showcasing my skills, projects, and achievements.
              </Box>
              <Box
                display={{ base: "column", sm: "column", lg: "flex" }}
                alignItems="baseline"
            ...
            >
              <a
                href="https://github.com/satyam46020/satyam46020.github.io"
                target="_blank"
                rel="noreferrer"
              >
                <Button
              ...
              <a
                href="https://satyam46020.github.io/"
                target="_blank"
                rel="noreferrer"
              >
                <Button
